...
import com.workintech.backend.twitter_clone.security.JwtAuthFilter;
...
public class SecurityConfig {
    ...
    // AuthenticationManager (şimdilik UserDetailsService'e ihtiyaç yok)
    @Bean
    ...
    // React (3200 portu) erişimi için CORS
    @Bean
